...
.btn-ghost.active i {
  ...
  .alert-success-soft { background: #f0fdf4; border-color: #bbf7d0; color: #166534; }
...
<div class="container py-4">
  ...
  <div class="d-flex flex-column flex-md-row justify-content-between align-items-start gap-3 mb-4">
    ...
    <div>
      <a href="{{ route('admin.dashboard') }}" class="btn btn-ghost d-inline-flex align-items-center gap-2">
  ...
  {{-- ALERTS --}}
  @if(session('success'))
    <div class="alert-soft alert-success-soft mb-4">
      ...
      <div class="card card-soft">
        <div class="card-body p-4">
          ...
          @if(isset($user->photo) && $user->photo)
            ...
            <form method="POST"
                  action="{{ route('admin.profil.photo.delete') }}"
                  onsubmit="return confirm('Apakah Anda yakin ingin menghapus foto profil?')">
              @csrf
              @method('DELETE')
              <button type="submit" class="btn btn-danger-soft w-100 d-inline-flex justify-content-center gap-2">
